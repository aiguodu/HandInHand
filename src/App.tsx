...
import { ChevronRight, ChevronLeft, RotateCcw, BookOpen, Target, Lightbulb, Play, Pause, Loader , Home } from 'lucide-react';
              ...
              <AnimatePresence>
                {showQuestion && (
                  <motion.div initial={{ opacity: 0, y: 10, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: 10, scale: 0.95 }} className="absolute z-50 top-full left-0 mt-2 p-2 bg-white rounded-xl shadow-2xl border border-slate-200 w-[400px]">
                    ...
                    <img src="/images/7-1.png" alt="题目原题" className="w-full h-auto rounded-lg border border-slate-100" />
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
